...
- **배포 산출물에 포함**: `index.html`, `app.js`, `rulepack-schema.js`, `rulepack-validator.js`, `dist/krds-lint.js`, `dist/jargon-dictionary.js`, `electron/main.js`, `electron/preload.js`, `electron/package.json`
