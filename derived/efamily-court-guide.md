...
### F184 — 전자소송 "회원가입 신청" — 가입 자격·필요 서류·인증 수단 사전 안내 없음 ★★ [B/C]
- **위치**: 전자소송 > 회원가입 > 시작 화면
- **원문**: "회원가입 신청"
...
### F185 — 소장 작성 화면 "청구취지 입력" — 법률 용어·작성 예시 없음 ★★★ [A/C]
...
### F186 — 항소 기간 안내 — 판결 선고 후 2주 기한 경고 없음 ★★★ [B/C]
...
### F187 — "집행문 부여 신청" — 집행문이 무엇인지·필요 조건·발급 기관 안내 없음 ★★ [A]
- **위치**: 법원 민원 > 집행문 부여 신청
- **원문**: "집행문 부여 신청"
...
### F188 — "조정신청" — 소송과 조정의 차이·장점·조정 불성립 시 절차 안내 없음 ★★ [B/C]
...
### F189 — "법원 도서관 자료 열람 신청" — 열람 가능 자료 종류·사전 예약 필요 여부 안내 없음 ★ [B]
